      ...
      <div className='resume-preamble-container'>
        <Container className=''>
          ...
          <Row className='d-flex resume-cta-container'>
            ...
            <CTAButton level='primary' text={'Download Resume'} className='resume-cta-btn ' containerClassname='on-right' />
          </Row>
        </Container>
      </div>
      <div>
        <Container className='resume-iframe-container'>
          <Row>
            <iframe title='Rajeev Parmasar Resume PDF' className='resume-iframe' src="https://drive.google.com/file/d/18R7SSpg4i7U3Ch22S2asZyX97jNumvBm/preview" allow="autoplay"></iframe>
          </Row>
        </Container>
      </div>
    </>
